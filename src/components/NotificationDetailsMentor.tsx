...
export default function NotificationDetailsStudent() {
	...
	return (
		<main className="min-h-screen w-full flex items-center justify-center  sm:p-10  ">
			<div className="max-w-2xl mx-auto   pt-8 bg-transparent rounded-md px-2 sm:px-10 ">
				<section className="flex justify-between items-center mb-6  ">
					...
					<span className=" px-[30px] text-gray-500  rounded-md text-lg transition-all ">
